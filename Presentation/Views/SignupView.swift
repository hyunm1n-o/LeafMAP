...
class SignupView: UIView {
    ...
    public let passwordTextField = TitleTextField(title: "비밀번호", placeholder: "비밀번호를 입력해 주세요")
    public let checkPasswordTextField = TitleTextField(title: "비밀번호 확인", placeholder: "비밀번호를 다시 입력해 주세요")
